...
const sendWithNodemailer = async ({ name, email, mobile, subject, message }) => {
      ...
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0f; color: #f1f5f9; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 30px;">
          ...
          <div style="margin-top: 24px;">
            ...
            <div style="background: #111118; border-left: 3px solid #6366f1; padding: 16px 20px; border-radius: 0 8px 8px 0; color: #f1f5f9; line-height: 1.7; font-size: 15px;">
              ${message.replace(/\n/g, '<br/>')}
            </div>
          </div>
      ...
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0f; color: #f1f5f9; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 30px;">
          ...
          <p style="color: #94a3b8; line-height: 1.8;">
            ...
            <a href="https://github.com/dishantsaini25" style="color: #6366f1;">GitHub</a> or connect with me on 
            <a href="https://linkedin.com/in/dishant-saini" style="color: #6366f1;">LinkedIn</a>.
          </p>
